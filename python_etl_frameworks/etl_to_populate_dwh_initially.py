...
destDatabase.execute('''CREATE SEQUENCE emp_sk START 1;''')
destDatabase.execute('''CREATE TABLE IF NOT EXISTS dim_emp (
      emp_id VARCHAR(50),
      ...
      valid_to DATE,
      version integer,
      emp_sk  integer primary key default nextval('emp_sk')  ) ''')
destDatabase.commit()

destDatabase.execute('''CREATE TABLE IF NOT EXISTS fact_sales_order (
      ord_id VARCHAR(50),
      emp_sk VARCHAR(255),
      unit_sold integer,
      tot_revenue integer,
